...
Game::Game(const Project_Description& description, bool display_fps, bool no_auto_save, const Optional<String>& record_filename, Input_Event_Provider& input, bool headless) :
	m_input{input},
	m_resource_system(description.path, m_game_facade, m_sequence_saveloader),
	...
	m_game_facade(m_resource_system.sequence_manager, m_music_player, m_logic_normal, m_camera_controller, m_map_saveloader, m_game_saveloader, m_logic, m_scriptable_gui, m_logic_combat.get_combat(), m_party, no_auto_save),
