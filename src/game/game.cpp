...
Game::Game(const Project_Description& description, bool display_fps, bool no_auto_save, const Optional<String>& record_filename, Input_Event_Provider& input, bool headless) :
	...
	m_game_saveloader(m_user_dir_provider, description.path, m_logic_normal, m_camera_controller, m_logic_normal.inventory, m_logic_normal.quest_log, m_resource_system.sequence_manager, m_resource_system.character_profile_manager, m_party, m_scriptable_gui, m_logic_combat, m_resource_system.texture_manager, m_logic),
	...
	m_logic_combat(m_logic, m_resource_system.sequence_manager, m_party),
	m_logic{m_game_saveloader, m_sequence_saveloader, m_resource_system.sequence_manager, m_logic_normal, m_logic_combat, description.start_sequence},
	m_game_facade(m_music_player, m_logic_normal, m_camera_controller, m_map_saveloader, m_game_saveloader, m_logic, m_scriptable_gui, m_logic_combat.get_combat(), m_party, m_sequence_saveloader, no_auto_save),
